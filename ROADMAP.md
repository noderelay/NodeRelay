...
- [ ] Horizontal pane splits — option to stack panes in horizontal rows, not just the current column-based auto layouts
- [ ] Pop-out window drag/arrange — with two or more channel windows open, drag to arrange/swap them like docked panes
