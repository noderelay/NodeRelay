...
- [ ] Horizontal pane splits — option to stack panes in horizontal rows, not just the current column-based auto layouts. Drag-to-rearrange becomes more valuable once this lands.
