...
<p align="center">
  <a href="https://github.com/noderelay/UplinkIRC/releases/latest/download/Uplink-2026.7.5-x86_64.AppImage">
  ...
  &nbsp;
  <a href="https://github.com/noderelay/UplinkIRC/releases/latest/download/Uplink-v2026.7.5-windows-x64.zip">
  ...
  &nbsp;
  <a href="https://github.com/noderelay/UplinkIRC/releases/latest/download/Uplink-v2026.7.5-macos-arm64.dmg">
...
| **Menu bar** | A lean **File / Edit / View / Settings / Help / Search** bar — joins the KDE global menu automatically, renders in-window everywhere else. Prefer a chrome-free window? `menu_style = "hidden"` keeps everything reachable by shortcut (**Ctrl+,** opens Preferences, **Ctrl+Q** quits). |
